...
function spjup_delete_form() {
    ...
    if (isset($bendid)) {
        ...
        if ($ada) {
			...
			$form['formdata'] = array (
				'#type' => 'fieldset',
				'#title'=> 'Konfirmasi Penghapusan Penerimaan Kas',
				'#collapsible' => TRUE,
				'#collapsed' => FALSE,        
			);
			...
			return confirm_form($form,
								'Anda yakin menghapus Penerimaan Kas Nomor/Tanggal : ' .  $spjno . ', ' . apbd_fd($spjtgl),
								$referer,
								'PERHATIAN : Penerimaan Kas yang dihapus tidak bisa dikembalikan lagi.',
...
function spjup_delete_form_validate($form, &$form_state) {
}

function spjup_delete_form_submit($form, &$form_state) {

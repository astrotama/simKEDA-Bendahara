...
function spjgaji_delete_form() {
    ...
    if (isset($bendid)) {
        ...
        if ($ada) {
			...
			$form['formdata'] = array (
				'#type' => 'fieldset',
				'#title'=> 'Konfirmasi Penghapusan SPJ Gaji',
				'#collapsible' => TRUE,
				'#collapsed' => FALSE,        
			);
...
function spjgaji_delete_form_validate($form, &$form_state) {
}

function spjgaji_delete_form_submit($form, &$form_state) {

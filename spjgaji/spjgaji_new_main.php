<?php
function spjgaji_new_main($arg=NULL, $nama=NULL) {
	$qlike='';
	$limit = 10;
	...
	if ($arg) {
        ...
        //$r = (1 == $v) ? 'Yes' : 'No';
		//$bulan = date('m');
		isset($_SESSION["spjgaji_new_bulan"])?$bulan = $_SESSION["spjgaji_new_bulan"]:$bulan = '1';
		isset($_SESSION["spjgaji_new_spjsudah"])?$spjsudah = $_SESSION["spjgaji_new_bulan"]:$spjsudah = 'ZZ';
		isset($_SESSION["spjgaji_new_jenisgaji"])?$jenisgaji = $_SESSION["spjgaji_new_jenisgaji"]:$jenisgaji = 'ZZ';
	...
	foreach ($results as $data) {
		...
		$editlink = createlink('SPJ','edit/' . $data->dokid);
	...
	$output_form = drupal_get_form('spjgaji_new_main_form');
	return drupal_render($output_form) . $table;
	
}


function spjgaji_new_main_form_submit($form, &$form_state) {
	...
	*/
	...
	$_SESSION["spjgaji_new_bulan"] = $bulan;
	$_SESSION["spjgaji_new_spjsudah"] = $spjsudah;
	$_SESSION["spjgaji_new_jenisgaji"] = $jenisgaji;
...
function spjgaji_new_main_form($form, &$form_state) {
	$kodeuk = apbd_getuseruk();
	if(arg(2)!=null){
		...
		//$bulan = date('m');
		//isset($_SESSION["spjgaji_new_bulan"])?$bulan = $_SESSION["spjgaji_new_bulan"]:$bulan = date('m');;
		//isset($_SESSION["spjgaji_new_spjsudah"])?$spjsudah = $_SESSION["spjgaji_new_bulan"]:$spjsudah = 'ZZ';
		//isset($_SESSION["spjgaji_new_jenisgaji"])?$jenisgaji = $_SESSION["spjgaji_new_jenisgaji"]:$jenisgaji = 'ZZ';
